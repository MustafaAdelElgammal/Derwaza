...
class AcmePresenterWeb extends BootstrapThreePresenter {
    ...
    public function getButtonNext() {
        ...
        if(!empty($url)){
            return $btn = "<a href='".$url."' class='btn btn-success-alt btn-block load-more-ajax'>".trans('admin.load_more')." <i class='fa fa-right'></i></a>";
        }
        return '';
    }
