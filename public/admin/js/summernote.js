...
(function (factory) {
  ...
  var checkbox = renderer.create('<div class="checkboxLink"></div>', function ($node, options) {
      $node.html([
  ...
  */
  ...
  var Editor = function (context) {
    ...
    this.createLink = this.wrapCommand(function (linkInfo) {
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        if (linkUrl.indexOf("#") == -1 && linkUrl.indexOf("http://") == -1 ) {
            $(anchor).attr('id', linkUrl);
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-form-group">' +
                 ...
                 '<div class="form-group note-form-group">' +
                   ...
                   '<input dir="ltr" class="note-link-url form-control note-form-control ' +
                   'note-input" type="text" value="# or http:// or id" placeholder="# or http:// or id" />' +
                 '</div>' +

      (!options.disableLinkTarget ?
          $('<div/>').append(ui.checkbox({ id: 'sn-checkbox-open-in-new-window', text: lang.link.openInNewWindow, checked: false }).render())
              .html()
          : '');
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      fontSizes: ['8', '9', '10', '11', '12', '14', '16', '18', '36'],
