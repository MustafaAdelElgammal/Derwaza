        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title"> @lang('admin.edit_user')</h4>
                </div>
                <div class="panel-body">
                    {{ Form::model($user, array('route' => array('admin.users.update',$user->id),'method'=> 'put','files' => true, 'class' => 'submit-ajax', 'id' => 'users-management')) }}
